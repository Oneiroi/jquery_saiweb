...
function decode(elem,params){var opts={delay:150,duration:3000,text:''};$.extend(opts,params);var tlen=opts.text.length;var srand='qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890!@£$%^&*ÁÛ#¢';var slen=srand.length;var rand=0;var walk=1;var total=(opts.delay*tlen)+opts.duration;var out='';var tout=opts.delay;console.log("%s",total);for(i=opts.delay;i<=total;i=i+opts.delay){for(j=0;j<tlen;j++){rand=Math.floor(Math.random()*slen);out=out+srand.charAt(rand);}
...
walk++;}
elem.html(out);},i);}}
$.fn.showhide=function(params){showhide(this,params);return this;};$.fn.typewriter=function(params){typewriter(this,params);return this;};$.fn.decoder=function(params){decoder(this,params);return this;};})(jQuery);